...
to reportar-estadisticas
  ...
  <widgets>
    <view x="380" wrappingAllowedX="true" y="35" frameRate="30" minPycor="-16" height="438" showTickCounter="true" patchSize="13" fontSize="10" wrappingAllowedY="true" width="437" tickCounterLabel="ticks" maxPycor="16" updateMode="0" maxPxcor="16" minPxcor="-16"></view>
    <slider x="10" step="0.1" y="45" max="2" width="190" display="lambda" height="50" min="0.1" direction="Horizontal" default="50" variable="lambda"></slider>
    <slider x="10" step="0.1" y="105" max="3" width="190" display="mu" height="50" min="0.5	" direction="Horizontal" default="50" variable="mu"></slider>
    <slider x="10" step="1" y="160" max="10" width="190" display="k" height="50" min="1" direction="Horizontal" default="50" variable="k"></slider>
    <button x="15" y="225" height="50" disableUntilTicks="false" forever="false" kind="Observer" display="setup" width="85" sizeVersion="0">setup</button>
    <button x="115" y="225" height="50" disableUntilTicks="false" forever="true" kind="Observer" display="go" width="80" sizeVersion="0">go</button>
    <button x="15" y="285" height="50" disableUntilTicks="false" forever="false" kind="Observer" display="go once" width="85" sizeVersion="0">go</button>
    <button x="115" y="285" height="50" disableUntilTicks="false" forever="false" kind="Observer" display="Estadísticas" width="85" sizeVersion="0">reportar-estadísticas</button>
    <monitor x="225" precision="0" y="45" height="60" fontSize="11" display="Clientes en sistema(Ns)" width="130" sizeVersion="0">Ns</monitor>
    <monitor x="225" precision="0" y="115" height="60" fontSize="11" display="Clientes en cola (Nw)" width="135" sizeVersion="0">Nw</monitor>
    <monitor x="225" precision="2" y="185" height="60" units="ticks" fontSize="11" display="Tiempo en sistema (Ts)" width="135" sizeVersion="0">precision Ts 2</monitor>
    <monitor x="225" precision="2" y="255" height="60" units="ticks" fontSize="11" display="Tiempo en cola (Tw)" width="135" sizeVersion="0">precision Tw 2</monitor>
    <monitor x="225" precision="4" y="325" height="60" fontSize="11" display="Pb teórica" width="135" sizeVersion="0">precision Pb-teorica 4</monitor>
    <monitor x="225" precision="4" y="395" height="60" units="clientes" fontSize="11" display="λ efectiva" width="135" sizeVersion="0">precision lambda-efectiva 4</monitor>
    <monitor x="225" precision="0" y="465" height="60" fontSize="11" display="Clientes completados" width="135" sizeVersion="0">clientes-completados</monitor>
    <monitor x="225" precision="0" y="535" height="60" fontSize="11" display="Ticks" width="135" sizeVersion="0">ticks</monitor>
  </widgets>
  <info>## WHAT IS IT?
